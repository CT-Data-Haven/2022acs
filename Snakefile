...
rule meta:
    ...
    shell:
        r_with_args("scripts/00_make_meta.R")
...
rule fetch:
    ...
    shell:
        r_with_args("scripts/01_fetch_acs_data.R")
...
rule calc_cws:
    ...
    shell:
        r_with_args("scripts/02_calc_cws_data.R")
...
rule calc_acs_towns:
    ...
    shell:
        r_with_args("scripts/03_calc_acs_towns.R")
...
rule calc_acs_nhoods:
    ...
    shell:
        r_with_args("scripts/04_calc_acs_nhoods.R")
...
rule prep_distro:
    ...
    shell:
        r_with_args("scripts/05_assemble_for_distro.R")
